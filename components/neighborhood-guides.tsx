...
const neighborhoods = [
  {
    ...
    description:
      "Iconic luxury living with world-class shopping, dining, and entertainment in the heart of Los Angeles.",
    medianPrice: "$3.2M",
    priceChange: "+8.5%",
    rating: 4.9,
  ...
  },
  {
    ...
    description: "Prestigious neighborhood featuring luxury condos, cultural institutions, and Central Park proximity.",
    medianPrice: "$2.8M",
    priceChange: "+12.3%",
    rating: 4.8,
  ...
  },
  {
    ...
    description: "Exclusive oceanfront properties with stunning Pacific views and private beach access.",
    medianPrice: "$4.1M",
    priceChange: "+15.7%",
    rating: 4.9,
  ...
  },
  {
    ...
    description: "Mountain luxury with world-class skiing, exclusive resorts, and breathtaking alpine scenery.",
    medianPrice: "$5.2M",
    priceChange: "+18.2%",
    rating: 4.8,
    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-stone-50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="font-serif text-4xl md:text-5xl font-light text-stone-900 mb-6">Neighborhood Guides</h2>
          <p className="text-xl text-stone-600 max-w-3xl mx-auto leading-relaxed">
            Discover the most exclusive neighborhoods and understand what makes each location unique for luxury living.
          </p>
        </div>
          ...
          {neighborhoods.map((neighborhood, index) => (
            <Card key={index} className="group overflow-hidden hover:shadow-xl transition-all duration-300">
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="flex items-center justify-between text-white">
                    <h3 className="font-serif text-2xl font-light">{neighborhood.name}</h3>
              ...
              <CardContent className="p-6 space-y-4">
                <p className="text-stone-600 leading-relaxed">{neighborhood.description}</p>
                ...
                <div className="grid grid-cols-3 gap-4 py-4 border-t border-stone-200">
                  <div className="text-center">
                    <div className="font-serif text-lg font-medium text-stone-900">{neighborhood.medianPrice}</div>
                    <div className="text-xs text-stone-500">Median Price</div>
                  </div>
                  <div className="text-center">
                    <div className="flex items-center justify-center gap-1 text-emerald-600">
                      <TrendingUp className="h-3 w-3" />
                      <span className="font-medium">{neighborhood.priceChange}</span>
                    </div>
                  ...
                  <div className="text-center">
                    <div className="flex items-center justify-center gap-1">
                      ...
                      <span className="font-medium text-stone-900">{neighborhood.properties}</span>
                    </div>
