...
const reports = [
  {
    title: "Q4 2024 Premium Market Report",
    description:
      "Comprehensive analysis of premium property trends, pricing dynamics, and market forecasts for the upcoming quarter.",
    date: "December 2024",
  ...
  },
  {
    ...
    description:
      "Deep dive into waterfront premium properties, including market performance and investment opportunities.",
    date: "November 2024",
  ...
  {
    title: "High-Rise Premium Condos",
    description:
      "Market dynamics and trends in premium high-rise condominium developments across prime locations.",
    date: "October 2024",
  ...
  },
  {
    ...
    description:
      "Analysis of large estate properties, including market trends and buyer preferences in the premium segment.",
    date: "September 2024",
    category: "Quarterly Report",
    trend: "+6.7%",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-stone-600 max-w-3xl mx-auto leading-relaxed">
            Access our comprehensive market reports and stay informed about the
            latest trends in premium real estate markets.
          </p>
        </div>
            ...
            >
              <CardHeader className="pb-4">
                <div className="flex items-start justify-between mb-4">
                  <Badge
                    variant={report.featured ? "default" : "secondary"}
                    className="mb-2"
                  >
                    {report.category}
                  </Badge>
