...
const analyses = [
  {
    title: "Premium Condo ROI Analysis",
    description:
      "Comprehensive return on investment analysis for premium condominium properties across prime markets.",
    roi: "12.8%",
  ...
  },
  {
    ...
    description:
      "Analysis of waterfront premium properties as long-term investment vehicles with scarcity premium.",
    roi: "15.2%",
  ...
  },
  {
    ...
    description:
      "Investment opportunities in premium commercial properties including retail and office spaces.",
    roi: "9.7%",
...
const investmentTips = [
  {
    ...
    description:
      "Spread investments across different property types and locations to minimize risk.",
  },
  {
    icon: TrendingUp,
    title: "Market Timing",
    description:
      "Understanding market cycles helps optimize entry and exit points for maximum returns.",
  },
  {
    icon: PieChart,
    title: "Portfolio Balance",
    description:
      "Maintain optimal balance between growth properties and income-generating assets.",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-stone-600 max-w-3xl mx-auto leading-relaxed">
            Make informed investment decisions with our detailed analysis and
            market insights tailored for premium real estate investors.
          </p>
        </div>
          ...
          {analyses.map((analysis, index) => (
            <Card
              ...
              className={`group hover:shadow-lg transition-all duration-300 ${
                analysis.featured
                  ? "ring-2 ring-amber-200 bg-gradient-to-r from-amber-50 to-white"
                  : ""
              }`}
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <Badge
                        variant={
                          ...
                          analysis.marketTrend === "Strong Bull"
                            ? "default"
                            : "secondary"
                        }
                        className="ml-4"
                  ...
                  <div className="space-y-6">
                    <div className="text-center p-6 bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl">
                      ...
                      <div className="font-serif text-3xl font-light text-emerald-800 mb-1">
                        {analysis.roi}
                      </div>
        ...
        <div className="bg-stone-50 rounded-2xl p-8">
          <h3 className="font-serif text-3xl font-light text-stone-900 text-center mb-8">
